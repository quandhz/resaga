...
describe('utils/hoc/onSubmit/sagas', () => {
  ...
  describe('handleRequest() with minimum params - promise success', () => {
    ...
    it('should return onSuccess', () => {
      const expectedYield = makeCallback(submitFormSucceed, onSuccessCallback, mockRes, minParams.data, 'testPage', 'testForm');
  ...
  describe('handleRequest() with minimum params - promise fail', () => {
    ...
    it('should throw onError', () => {
      const expectedYield = makeCallback(submitFormFailed, onErrorCallback, mockErr, minParams.data, 'testPage', 'testForm');
  ...
  describe('handleRequest() with submit as object params - promise fail', () => {
    ...
    it('should throw onError', () => {
      const expectedYield = makeCallback(submitFormFailed, onErrorCallback, mockErr, minParams.data, 'testPage', formName);
      expect(generator.throw(mockErr).value).toEqual(expectedYield);
    });
  });
  ...
  describe('handleRequest() - promise success', () => {
    ...
    it('should callback onSuccess', () => {
      const expectedYield = makeCallback(submitFormSucceed, onSuccessCallback, handleSuccess(mockRes), data, 'testPage', 'testForm');
      expect(generator.next(mockRes).value).toEqual(expectedYield);
    });
  });
  ...
  describe('handleRequest() - promise fail', () => {
    ...
    it('should throw onError', () => {
      const expectedYield = makeCallback(submitFormFailed, onErrorCallback, handleError(mockErr), data, 'testPage', 'testForm');
      expect(generator.throw(mockErr).value).toEqual(expectedYield);
    });
  });
});
