...
import actions, {
  beforeSubmitForm, doAcknowledge, doCleanup, submitForm,
} from '../actions';
...
const resaga = (originConfigs) => (Component) => {
  ...
  class Resaga extends React.PureComponent {
    ...
    setValue = (...props) => helpers.setValue({
      ownProps: helpers.exportProps(this.props),
      internalProps: this.internalProps,
    }, ...props);


    getValue = (...props) => helpers.getValue(this.props, ...props);


    dispatch = (...props) => helpers.dispatch(...props, this.internalProps);


    dispatchTo = (...props) => helpers.dispatchTo(...props, this.internalProps);


    analyse = (nextProps = {}, action = {}) => helpers.analyseNextProps(nextProps, action, this.internalProps);


    isLoading = (...props) => helpers.isLoading(this.internalProps, this.props, ...props);
  ...
  Resaga.displayName = `WithResaga(${utils.getDisplayName(Component)})`;
