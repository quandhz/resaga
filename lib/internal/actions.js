...
export function submitForm({ name, requestName, payload, options = { configs: {} } }) {
...
export function setVariable(name, key, value, callback) {
  return {
...
export function setVariableWithFunction(name, key, func, callback) {
  return {
