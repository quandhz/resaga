...
import { doSubmit } from '../helpers/analyseConfig';
...
describe('resaga/sagas', () => {
  ...
  describe('handleRequest() with minimum params - promise success', () => {
    ...
    it('should return onSuccess', () => {
      const expectedYield = makeCallback(submitFormSucceed, onSuccessCallback, mockRes, minParams.payload, minParams.name, minParams.requestName, minParams.options);
  ...
  describe('handleRequest() with minimum params - promise fail', () => {
    ...
    it('should throw onError', () => {
      const expectedYield = makeCallback(submitFormFailed, onErrorCallback, mockErr, minParams.payload, minParams.name, minParams.requestName, minParams.options);
  ...
  describe('handleRequest() with submit as object params - promise fail', () => {
    ...
    it('should throw onError', () => {
      const expectedYield = makeCallback(submitFormFailed, onErrorCallback, mockErr, objectParams.payload, objectParams.name, objectParams.requestName, objectParams.options);
      expect(generator.throw(mockErr).value).toEqual(expectedYield);
    });
  });
  ...
  describe('handleRequest() - promise success', () => {
    ...
    it('should callback onSuccess', () => {
      const expectedYield = makeCallback(submitFormSucceed, onSuccessCallback, handleSuccess(mockRes), params.payload, params.name, params.requestName, params.options);
      expect(generator.next(mockRes).value).toEqual(expectedYield);
    });
  });
  ...
  describe('handleRequest() - promise fail', () => {
    ...
    it('should throw onError', () => {
      const expectedYield = makeCallback(submitFormFailed, onErrorCallback, handleError(mockErr), params.payload, params.name, params.requestName, params.options);
      expect(generator.throw(mockErr).value).toEqual(expectedYield);
    });
  });
});
