...
describe('utils/hoc/onSubmit/sagas', () => {
  ...
  describe('handleRequest() with minimum params - promise success', () => {
    ...
    it('should return onSuccess', () => {
      const expectedYield = makeCallback(submitFormSucceed, onSuccessCallback, minParams.name, minParams.formName, minParams.payload, minParams.options, mockRes);
  ...
  describe('handleRequest() with minimum params - promise fail', () => {
    ...
    it('should throw onError', () => {
      const expectedYield = makeCallback(submitFormFailed, onErrorCallback, minParams.name, minParams.formName, minParams.payload, minParams.options, mockErr);
  ...
  describe('handleRequest() with submit as object params - promise fail', () => {
    ...
    it('should throw onError', () => {
      const expectedYield = makeCallback(submitFormFailed, onErrorCallback, objectParams.name, objectParams.formName, objectParams.payload, objectParams.options, mockErr);
      expect(generator.throw(mockErr).value).toEqual(expectedYield);
    });
  });
  ...
  describe('handleRequest() - promise success', () => {
    ...
    it('should callback onSuccess', () => {
      const expectedYield = makeCallback(submitFormSucceed, onSuccessCallback, params.name, params.formName, params.payload, params.options, handleSuccess(mockRes));
      expect(generator.next(mockRes).value).toEqual(expectedYield);
    });
  });
  ...
  describe('handleRequest() - promise fail', () => {
    ...
    it('should throw onError', () => {
      const expectedYield = makeCallback(submitFormFailed, onErrorCallback, params.name, params.formName, params.payload, params.options, handleError(mockErr));
      expect(generator.throw(mockErr).value).toEqual(expectedYield);
    });
  });
});
