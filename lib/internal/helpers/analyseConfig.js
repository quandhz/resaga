...
const analyse = ({
  ...
  else if (typeof onSuccessEach === 'function') onSuccessEach = [onSuccessEach];

  if (!Array.isArray(onErrorEach)) onErrorEach = onErrorEach[requestName];
  else if (typeof onErrorEach === 'function') onErrorEach = [onErrorEach];

  console.log('submitEach', submitEach);
