...
export const resaga = (configs) => (Component) => {
  if (configs.page && !configs.name) {
    ...
    errors.ResagaWarning('`CONFIG.page` is renamed to `CONFIG.name`. Please adapt your code immediately. `CONFIG.page` will not be supported in the next minor release.');
