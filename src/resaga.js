...
import { MANUALLY_CLEANUP, BEFORE_SUBMIT } from './config';
...
ReSaga.propTypes = {
  ...
  dispatchProp: React.PropTypes.func,
  acknowledgeProp: React.PropTypes.func,
  cleanupProp: React.PropTypes.func,
